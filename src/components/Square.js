  ...
  return (
    <>
      ...
      <div className="w-full h-full">
        <div className="w-[1280px] flex justify-center items-center mx-auto ">
          <div className=" w-full relative " >
            <div className="md:overflow-hidden">
            <div className="mt-20 orbit"></div>
            </div>
            {/* <div
            ...
            ><p className='mt-6'>eun seong</p></div> */}
            {/* <div
              className="w-[50px] h-[50px] rounded-full absolute bg-gray-800"
              style={{
                animation: 'rotation 6s infinite linear',
                left: 'calc(100% - 25px)',
                top: 'calc(50% - 25px)',
